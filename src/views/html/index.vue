                ...
                <div class="card-body">
                  ...
                  <div class="hstack gap-2 mb-3">
                    ...
                    <div class="overflow-hidden">
                      <a class="h6 mb-0" href="#!">最新新闻</a>
                      <p class="mb-0 small text-truncate">最新新闻报道</p>
                    </div>
                    <!-- Button -->
                  ...
                  <div class="hstack gap-2 mb-3">
                    ...
                    <div class="overflow-hidden">
                      <a class="h6 mb-0" href="#!">最新新闻</a>
                      <p class="mb-0 small text-truncate">最新新闻111</p>
                    </div>
                    <!-- Button -->
                    <a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i
                        class="fa-solid fa-plus"> </i></a>
                  ...
                  <div class="hstack gap-2 mb-3">
                    ...
                    <div class="overflow-hidden">
                      <a class="h6 mb-0" href="#!">最新新闻</a>
                      <p class="mb-0 small text-truncate">最新新闻222</p>
                    </div>
                    <!-- Button -->
                  ...
                  <div class="hstack gap-2 mb-3">
                    ...
                    <!-- Title -->
                    <div class="overflow-hidden">
                      <a class="h6 mb-0" href="#!">111</a>
                      <p class="mb-0 small text-truncate">aaa最新新闻</p>
                    </div>
                    <!-- Button -->
                    <a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i
                        class="fa-solid fa-plus"> </i></a>
